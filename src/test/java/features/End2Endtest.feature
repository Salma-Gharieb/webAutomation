Feature: Automated End2End Test
  Scenario Outline: Admin login and add new record and delete the new record
    ...
    And navigate to add role page and insert user info "<role>","<status>","<empName>","<usrName>","<usrPass>"
...
#    And verify that number of records decreased by 1
    ...
    Examples:
      |username | password | role | status   | empName       | usrName  | usrPass      |
      |Admin    | admin123 | Admin | Enabled |Ranga  Akunuri | testuser | Password@123 |
